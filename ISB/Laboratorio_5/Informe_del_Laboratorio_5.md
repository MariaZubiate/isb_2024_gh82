...
|  *Ploteo Python*  | *Descripción*|
|![Prosim_etapa3](https://github.com/MariaZubiate/isb_2024_gh82/assets/164566714/c292c7f2-1af4-47c2-9dd3-420eede14bc7)|En esta fase, el corazón comienza a latir anormalmente rápido, a unos 160 latidos por minuto, en un ritmo originado en los ventrículos. Esta es una arritmia grave que puede ser inestable y puede llevar a una disminución del gasto cardíaco y la perfusión de órganos vitales, incluido el cerebro. Los modelos de redes neuronales convolucionales para el análisis de señales de ECG, como los propuestos por Wasimuddin et al. (2021), demuestran la utilidad del ProSim 4 de Fluke en la simulación de taquicardias para entrenar sistemas de diagnóstico automático[5].|
