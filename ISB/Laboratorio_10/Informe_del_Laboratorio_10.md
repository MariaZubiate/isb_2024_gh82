...
Se obtuvieron índices de Variabilidad de la Frecuencia Cardíaca (HRV) con variaciones significativas entre todos los tipos de experimentos realizados, reflejando los cambios fisiológicos subyacentes. El AVNN, o intervalo medio entre latidos, es mayor en reposo (963.20 ms) y disminuye durante el ejercicio intenso (713.59 ms) debido a la activación simpática tal como lo menciona , recuperándose parcialmente tras la respiración profunda post-ejercicio (830.31 ms) [1]. 
La desviación estándar de los intervalos NN (SDNN) muestra una variabilidad más alta en condiciones de recuperación (90.68 ms) y más baja durante el ejercicio (41.76 ms), indicando fluctuaciones de ritmo más estables en reposo [2]. La RMSSD, una medida de la variabilidad a corto plazo, es mayor en reposo (74.61 ms) y disminuye con la respiración profunda y el ejercicio, reflejando la respuesta del sistema nervioso autónomo [3]. 
El pNN50, que mide la proporción de intervalos sucesivos que difieren en más de 50 ms, es significativamente alto durante la respiración profunda antes del ejercicio (34.09%), sugiriendo una mayor influencia parasimpática [4]. 
Los valores de VLF y LF son nulos debido a la corta duración de los registros (40-50 segundos), insuficientes para un análisis adecuado de estas bandas de frecuencia, en contraste con los resultados más robustos del artículo base con registros de 260 minutos [5]. 
