...
El pNN50, que mide la proporción de intervalos sucesivos que difieren en más de 50 ms, es significativamente alto durante la respiración profunda antes del ejercicio (34.09%). Según el estudio M. K. Jensen et al., más allá de las patologías existentes en los pacientes, a partir de la estimulación del nervio vago se obtuvo una cifra alta para el pNN50, y esto sugiere una mayor influencia parasimpática. Este estudio confirma que el pNN50 también es un buen indicador de la actividad parasimpática y que su aumento durante la respiración profunda está relacionado a una mayor activación vagal. Además, los parámetros de HRV, incluyendo el pNN50, aumentaron significativamente después de ejercicios de respiración profunda, lo que verifica su utilidad para evaluar la respuesta del sistema nervioso autónomo durante estas condiciones​[10].
