...
#FFT Señal Filtrada: 
Pico principal en 0 Hz con una magnitud reducida a aproximadamente 4.5e5. La reducción del pico en un 10% muestra que parte del ruido de baja frecuencia ha sido atenuado. Picos secundarios aún presentes aunque atenuados, indicando que el artefacto de parpadeo no se ha eliminado completamente con el filtrado wavelet actual.|
