...
El tercer experimento, realizado bajo condiciones de contrafuerza, confirmó la superioridad del filtro Sym8, con un SNR de 16.89 dB, proporcionando una reducción efectiva del ruido sin comprometer los detalles finos de la señal EMG. El filtro Db4 mostró el SNR más alto en este experimento con 23.22 dB, aunque su rendimiento en términos de MSE y RMS fue menos consistente en comparación con Sym8. El filtro Rbio3.1, con un SNR de 3.10 dB, fue el menos efectivo en estas condiciones, subrayando sus limitaciones en la capacidad de preservación de la señal y reducción de ruido en escenarios de alta actividad muscular.
